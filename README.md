...
```bash
git clone https://github.com/m-a-c-m/LicenseGenerator.git
cd LicenseGenerator
npm install
npm run dev
```
...
```env
NEXT_PUBLIC_SITE_URL=https://miguelacm.es/tools/license-generator
NEXT_PUBLIC_EMBED_URL=https://miguelacm.es/embed/license-generator
```
